...
// NETS QR Routes
app.get('/netsQrHome', (req, res) => {res.render('netsQrHome')})
...
//Report Routes
app.get("/report", checkAdmin, reportController.getSalesReport);


//about 
app.get('/about', aboutController.aboutUs);

//contact
app.get("/contact", contactController.contactForm);
